...
@inject('sizes', 'App\Http\Utilities\Sized')
	        	...
	        	<div class="form-group">
                    <label for="color">Overall Color:</label>
                ...
                <div class="form-group">
                    <label for="company">Overall Printed:</label>
                ...
                <div class="form-group">
                    <label for="variant">With/Withour Reflector:</label>
                    <select id="variant" name="variant" class="form-control">
                        @foreach($variants::varianted() as $variant)
                ...
                <div class="form-group">
                    <label for="size">Overall Size:</label>
