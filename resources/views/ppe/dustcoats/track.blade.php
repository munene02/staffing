...
<a href="/dustcoats" class="btn bg-purple">GO BACK</a>
  <h1>Stock Tracking - Dustcoats</h1>
  <p>Below is a list all stock changes for Dustcoats.</p>
          ...
          <div class="box-body">
              <table class="table table-bordered">
                  ...
                  <tr>
                      ...
                      <td> {{ $track->variant }} </td>
                      @if($track->dustcoat->company == 'Plain')
                      <td>{{ $track->dustcoat->color }} {{ $track->dustcoat->company }}</td>
                      @else
                      <td>{{ $track->dustcoat->color }} Printed {{ $track->dustcoat->company }}</td>
                      @endif
                      <td> {{ $track->dustcoat->size }} </td>
