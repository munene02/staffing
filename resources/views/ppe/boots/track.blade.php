...
<a href="/boots" class="btn bg-purple">GO BACK</a>
  <h1>Stock Tracking - Boots</h1>
  <p>Below is a list all stock changes for Boots.</p>
          ...
          <div class="box-body">
              <table class="table table-bordered">
                  ...
                  <tr>
                      ...
                      <td> {{ $track->variant }} </td>
                      <td> {{ $track->boots->brand->brand }}</td>
                      <td> {{ $track->boots->bootHeight->height }}</td>
                      <td> {{ $track->boots->shoeSize->size }}</td>
