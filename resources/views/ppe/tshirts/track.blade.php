...
<a href="/tshirts" class="btn bg-purple">GO BACK</a>
  <h1>Tstock Tracking - Tshirts</h1>
  <p>Below is a list all stock changes for Tshirts.</p>

      <div class="box">
          <div class="box-header">
            <h3 class="box-title">Tstock Tracking</h3>
          </div>
          <div class="box-body">
              <table class="table table-bordered">
                  ...
                  <tr>
                      ...
                      <td> {{ $track->variant }} </td>
                      <td>{{ $track->tshirt->color }} </td>
                      <td> {{ $track->tshirt->size }} </td>
